...
Pod::Spec.new do |s|
  ...
  s.subspec "CxxBridge" do |ss|
    ...
    ss.dependency             "MXReact/Core"
    ss.dependency             "MXReact/cxxreact"
  ...
  s.subspec "DevSupport" do |ss|
    ss.dependency             "MXReact/Core"
    ss.dependency             "MXReact/RCTWebSocket"
  ...
  s.subspec "jschelpers" do |ss|
    ss.dependency             "Folly", "2016.09.26.00"
    ss.dependency             "MXReact/PrivateDatabase"
    ss.compiler_flags       = folly_compiler_flags
  ...
  s.subspec "cxxreact" do |ss|
    ss.dependency             "MXReact/jschelpers"
    ss.dependency             "MXReact/jsinspector"
  ...
  s.subspec "RCTWebSocket" do |ss|
    ss.dependency             "MXReact/Core"
    ss.dependency             "MXReact/RCTBlob"
    ss.dependency             "MXReact/fishhook"
